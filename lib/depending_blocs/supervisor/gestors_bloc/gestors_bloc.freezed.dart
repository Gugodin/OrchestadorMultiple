...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GestorsEvent);
}
...
/// @nodoc
class $GestorsEventCopyWith<$Res>  {
$GestorsEventCopyWith(GestorsEvent _, $Res Function(GestorsEvent) __);
}


/// Adds pattern-matching-related methods to [GestorsEvent].
extension GestorsEventPatterns on GestorsEvent {
...
class _Load implements GestorsEvent {
  const _Load();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GestorsState);
}
...
/// @nodoc
class $GestorsStateCopyWith<$Res>  {
$GestorsStateCopyWith(GestorsState _, $Res Function(GestorsState) __);
}


/// Adds pattern-matching-related methods to [GestorsState].
extension GestorsStatePatterns on GestorsState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements GestorsState {
  const _Initial();
...
class _Loading implements GestorsState {
  const _Loading();
...
class _Loaded implements GestorsState {
  const _Loaded();
...
class _Error implements GestorsState {
  const _Error(this.message);
  

 final  String message;

/// Create a copy of GestorsState
...
@override
String toString() {
  return 'GestorsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $GestorsStateCopyWith<$Res> {
