...
/// @nodoc
mixin _$CatalogsSupervisorEvent {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CatalogsSupervisorEvent);
}
...
@override
String toString() {
  return 'CatalogsSupervisorEvent()';
}
...
/// @nodoc
class $CatalogsSupervisorEventCopyWith<$Res>  {
$CatalogsSupervisorEventCopyWith(CatalogsSupervisorEvent _, $Res Function(CatalogsSupervisorEvent) __);
}


/// Adds pattern-matching-related methods to [CatalogsSupervisorEvent].
extension CatalogsSupervisorEventPatterns on CatalogsSupervisorEvent {
...
class _Load implements CatalogsSupervisorEvent {
  const _Load();
...
@override
String toString() {
  return 'CatalogsSupervisorEvent.load()';
}
...
/// @nodoc
mixin _$CatalogsSupervisorState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CatalogsSupervisorState);
}
...
@override
String toString() {
  return 'CatalogsSupervisorState()';
}
...
/// @nodoc
class $CatalogsSupervisorStateCopyWith<$Res>  {
$CatalogsSupervisorStateCopyWith(CatalogsSupervisorState _, $Res Function(CatalogsSupervisorState) __);
}


/// Adds pattern-matching-related methods to [CatalogsSupervisorState].
extension CatalogsSupervisorStatePatterns on CatalogsSupervisorState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements CatalogsSupervisorState {
  const _Initial();
...
@override
String toString() {
  return 'CatalogsSupervisorState.initial()';
}
...
class _Loading implements CatalogsSupervisorState {
  const _Loading();
...
@override
String toString() {
  return 'CatalogsSupervisorState.loading()';
}
...
class _Loaded implements CatalogsSupervisorState {
  const _Loaded();
...
@override
String toString() {
  return 'CatalogsSupervisorState.loaded()';
}
...
class _Error implements CatalogsSupervisorState {
  const _Error(this.message);
  

 final  String message;

/// Create a copy of CatalogsSupervisorState
...
@override
String toString() {
  return 'CatalogsSupervisorState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CatalogsSupervisorStateCopyWith<$Res> {
