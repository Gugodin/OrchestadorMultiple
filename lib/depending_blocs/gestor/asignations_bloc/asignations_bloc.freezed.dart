...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AsignationsEvent);
}
...
/// @nodoc
class $AsignationsEventCopyWith<$Res>  {
$AsignationsEventCopyWith(AsignationsEvent _, $Res Function(AsignationsEvent) __);
}


/// Adds pattern-matching-related methods to [AsignationsEvent].
extension AsignationsEventPatterns on AsignationsEvent {
...
class _Load implements AsignationsEvent {
  const _Load();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AsignationsState);
}
...
/// @nodoc
class $AsignationsStateCopyWith<$Res>  {
$AsignationsStateCopyWith(AsignationsState _, $Res Function(AsignationsState) __);
}


/// Adds pattern-matching-related methods to [AsignationsState].
extension AsignationsStatePatterns on AsignationsState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements AsignationsState {
  const _Initial();
...
@override
String toString() {
  return 'AsignationsState.initial()';
}
...
class _Loading implements AsignationsState {
  const _Loading();
...
@override
String toString() {
  return 'AsignationsState.loading()';
}
...
class _Loaded implements AsignationsState {
  const _Loaded();
...
@override
String toString() {
  return 'AsignationsState.loaded()';
}
...
class _Error implements AsignationsState {
  const _Error(this.message);
  

 final  String message;

/// Create a copy of AsignationsState
...
@override
String toString() {
  return 'AsignationsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $AsignationsStateCopyWith<$Res> {
