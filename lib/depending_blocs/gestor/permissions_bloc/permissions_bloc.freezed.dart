...
class _Load implements PermissionsEvent {
  const _Load();
...
/// @nodoc
class $PermissionsStateCopyWith<$Res>  {
$PermissionsStateCopyWith(PermissionsState _, $Res Function(PermissionsState) __);
}
...
class _Loading implements PermissionsState {
  const _Loading();
...
class _Loaded implements PermissionsState {
  const _Loaded();
...
class _Error implements PermissionsState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $PermissionsStateCopyWith<$Res> {
