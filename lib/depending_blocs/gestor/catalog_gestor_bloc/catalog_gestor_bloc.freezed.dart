...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CatalogGestorEvent);
}
...
/// @nodoc
class $CatalogGestorEventCopyWith<$Res>  {
$CatalogGestorEventCopyWith(CatalogGestorEvent _, $Res Function(CatalogGestorEvent) __);
}


/// Adds pattern-matching-related methods to [CatalogGestorEvent].
extension CatalogGestorEventPatterns on CatalogGestorEvent {
...
class _Load implements CatalogGestorEvent {
  const _Load();
...
@override
String toString() {
  return 'CatalogGestorEvent.load()';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CatalogGestorState);
}
...
/// @nodoc
class $CatalogGestorStateCopyWith<$Res>  {
$CatalogGestorStateCopyWith(CatalogGestorState _, $Res Function(CatalogGestorState) __);
}


/// Adds pattern-matching-related methods to [CatalogGestorState].
extension CatalogGestorStatePatterns on CatalogGestorState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements CatalogGestorState {
  const _Initial();
...
@override
String toString() {
  return 'CatalogGestorState.initial()';
}
...
class _Loading implements CatalogGestorState {
  const _Loading();
...
@override
String toString() {
  return 'CatalogGestorState.loading()';
}
...
class _Loaded implements CatalogGestorState {
  const _Loaded();
...
@override
String toString() {
  return 'CatalogGestorState.loaded()';
}
...
class _Error implements CatalogGestorState {
  const _Error(this.message);
  

 final  String message;

/// Create a copy of CatalogGestorState
...
@override
String toString() {
  return 'CatalogGestorState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CatalogGestorStateCopyWith<$Res> {
